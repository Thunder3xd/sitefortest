# Generated by Django 4.0.6 on 2022-07-14 08:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Publicat')),
                ('photo', models.ImageField(blank=True, upload_to='photo/%Y/%m/%d')),
                ('views', models.IntegerField(default=0, verbose_name='Numaru de vizualizari')),
